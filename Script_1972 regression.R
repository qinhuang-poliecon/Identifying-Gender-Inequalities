...
data_fl <- data_fl %>% 
  mutate(V99 = plyr::mapvalues(V99, from = c("2", "3", "4","5","6", "7", "8"), to = c("0","0","0","0","0","0", "0"))) %>%
...
whole1 <- glm(as.factor(vote) ~ as.factor(V231)  + as.numeric(V77)*as.factor(V231) + as.numeric(V116)*as.factor(V231) + as.numeric(V193)*as.factor(V231) + as.numeric(V59)*as.factor(V231)+ as.numeric(V204)*as.factor(V231) + as.factor(V648)*as.factor(V231), data = imputed_data, family = binomial)
...
male1<- glm(as.factor(vote) ~ as.numeric(V77) + as.numeric(V193) + as.numeric(V116) + as.numeric(V151), data = imputed_male, family = binomial)

summary(male1)



male3 <- glm(as.factor(vote) ~ as.numeric(V77) + as.numeric(V193) + as.numeric(V116) + as.numeric(V151) + as.factor(V648) + as.numeric(V204), data = imputed_male, family = binomial)
...
female1 <- glm(as.factor(vote) ~ as.numeric(V77) + as.numeric(V193) + as.numeric(V116) + as.numeric(V151), data = imputed_female, family = binomial)

summary(female1) 



female3 <- glm(as.factor(vote) ~ as.numeric(V77) + as.numeric(V193) + as.numeric(V116) + as.numeric(V151) + as.factor(V648) + as.numeric(V204), data = imputed_female, family = binomial)

summary(female3) ## 77, 116, 193 remains
